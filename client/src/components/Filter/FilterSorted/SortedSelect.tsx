...
function SortedSelect() {
    ...
    useEffect(() => {
        ...
        !!sortedByUserFilter
            ? setUserFilter(sortedByUserFilter)
            : setUserFilter(UserFilter.DEFAULT);
    }, [filters]);
        ...
        <>
            ...
            <FormControl sx={{ p: 1, minWidth: '100%' }}>
                <TextField
                    ...
                    id="select-sorted"
                >
                    <MenuItem value={FilterPopularity.PopularityDescending}>
                    ...
                    <MenuItem value={FilterPopularity.RateAscending}>
